...
//        processBuilder.command("java","-jar","f:/xc-service-manage-course.jar");
    ...
    public void testProcessMp4(){
        ...
        //ffmpeg的路径
        String ffmpeg_path = "D:/sofwares/ffmpcg/ffmpeg-20191226-b0d0d7e-win64-static/ffmpeg-20191226-b0d0d7e-win64-static/bin/ffmpeg.exe";
        //video_path视频地址
        String video_path = "E:\\avi\\01.avi";
        //mp4_name mp4文件名称
        String mp4_name  ="1.mp4";
        //mp4folder_path mp4文件目录路径
        String mp4folder_path="E:\\avi\\";
